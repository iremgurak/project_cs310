import 'package:project_cs310/widgets/constant.dart';
...
class Champion {
  ...
  const Champion(
      {required this.name, required this.nickName, required this.difficulty, required this.role, required this.description});
}
